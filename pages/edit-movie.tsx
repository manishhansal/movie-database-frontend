...
const EditMoviePage: React.FC = () => {
  ...
  return (
    <div className="add-movie-container">
      ...
      <Formik
        initialValues={{ title: initialMovie.title, year: initialMovie.year, image: initialMovie.image }}
        validationSchema={EditMovieSchema}
        onSubmit={(values, { setSubmitting }) => {
          // TODO: Handle movie update
          setSubmitting(false);
          router.push('/movies');
        }}
      >
          ...
          <Form className="add-movie-form">
            ...
            <div className="add-movie-fields">
              ...
              <div className="add-movie-actions">
                ...
                <button type="submit" className="add-movie-submit" disabled={isSubmitting}>Update</button>
              </div>
            </div>
          </Form>
        )}
